...
export class AppState {
  ...
  public clone(): AppState {
    ...
    clone.localState = new Map(Array.from(this.localState.entries(), ([key, value]) => [key, value.clone()]))
    clone.boxState = this.boxState.clone()
    return clone
  }

  public static fromAppInitialState(initialState: algosdk.modelsv2.ApplicationInitialStates): AppState {
